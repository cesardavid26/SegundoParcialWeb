...
<div class="col-xs-12 col-sm-6 col-md-3 align-self-center">
            	<a href="tiendaView/formServicio.jsp" class="btn btn-lg btn-primary btn-block text-uppercase font-weight-bold mb-2 text-light" type="submit">Agregar Servicio</a>
            </div>
  <div class="row">
